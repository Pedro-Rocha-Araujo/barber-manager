...
router.delete("/cancelar-agendamento/:id_agendamento", checarToken, checarAdmin, cancelarAgendamento)
router.put("/desmarcar-agendamento/:id_agendamento", checarToken, desmarcarAgendamento)
